...
class Game extends Component {
    ...
    render() {
        ...
        console.log(this.state.remWord)
        return (
            <div className="Game">
                <h1>Hangman Game!</h1>
                ...
                <div className="Game-word-container"> 
                        {word.map((letter, i) => (
                            <div className="Game-word-letter-container">
                                <h1 key={ i } className={remWord.includes(letter) ? "Game-word-letter-hide" : "Game-word-letter"}>{ letter }</h1>
                            </div>
                        ))}
                </div>
                ...
                <button onClick={this.replay} className="Game-button-replay">New game?</button>
            </div>
        )
    }
}
